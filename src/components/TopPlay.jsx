    ...
    <div className="w-full flex flex-row items-center hover:bg-[#4c426e] py-2 p-4 rounded-lg cursor-pointer mb-2">
      ...
      <div className="flex-1 flex flex-row justify-between items-center">
        <img
          ...
          src={song?.images?.coverart ? song?.images?.coverart : reactLogoTemp}
          alt={song?.title}
        />
...
const TopPlay = () => {
  ...
  return (
    <div
      ref={divRef}
      className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex-col"
    >
      ...
      <div className="w-full flex flex-col mt8">
        <div className="flex flex-row justify-between items-center">
        ...
        >
          {topPlays?.map((song, i) => (
            ...
            >
              <Link to={`/artists/${song.artists && song.artists[0].adamid}`}>
                <img
                  src={song?.images?.background ? song?.images?.background : reactLogoTemp}
                  alt="name"
